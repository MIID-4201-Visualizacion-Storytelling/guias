...
Si necesitan ayuda para elegir, la recomendación es utilizar Looker Studio (https://lookerstudio.google.com/), una herramienta robusta, gratuita, no requiere instalación local (se usa en navegador) y con excelente documentación que permite publicar en la web sus resultados.
